            ...
            <div className="problemAndSolution">
                <div className="Problembit">
                    ...
                    <div className="problemText">
                        <div className="T1">
                            NJFP EXISTS TO SOLVE ONE BIG PROBLEM
                        </div>

                        <div className="T2">
                            Graduates can’t get jobs because they lack experience and they can’t get experience because they don’t have jobs.
                        </div>
                    </div>
                </div>
                ...
                <div className="Problembit">
                    ...
                    <div className="problemText">
                        ...
                        <div className="T2">
                            NJFP bridges the gap between education and employment by placing graduates into real work environments, equipping them with hands-on experience, mentorship.
                        </div>
                    </div>
                </div>
            </div>
...
For participants, I designed flows that guide them from onboarding through profile creation, eligibility checks, and matching helping them clearly present their skills and transition smoothly into opportunities.
            ...
            <div className="organisation">
                <div className="orgtitle">
                    HOST ORGANIZATION AND PARTICIPANT FLOWS.
                </div>
